<div align = "center"><p style = "font-size: 40px"><b>SkiNet</b></p><br>
<p style = "font-size: 30px"><i>"Using deep learning to predict the popularity of pictures from ski resorts"</i></p><br><br><br></div>
